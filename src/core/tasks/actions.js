...
import {
  ...
  UPDATE_TASK_ERROR,
  UPDATE_TASK_SUCCESS,
  LOAD_TASK_FOR_EDITING
} from './action-types';
export var taskToEdit = new Task;
// this.taskToEdit = setupNewTask();
...
export function loadTaskForEditing(editTask) {
  var returnTask = setupNewTask();
  returnTask = editTask?editTask:this.taskToEdit;
  return returnTask;
}
